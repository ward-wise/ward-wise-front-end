  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className=" w-full flex items-center justify-center mt-96 shadow-xl rounded-lg border-l-2 lg:border-l-4 " id="WhatIs">
        ...
        <div className="h-60 p-4 flex justify-center items-center text-left w-2/4 text-sm lg:text-xl 2xl:text-2xl lg:leading-6 leading-4 tracking-tight border-l-4 lg:border-l-8 border-sky-400 rounded-lg flex-col">
          <p>
          ...
          <Link className='underline mt-8 text-sky-500 font-bold' href={'/find-my-ward'}>Find your ward</Link>
        </div>
      </article>
